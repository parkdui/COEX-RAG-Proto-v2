...
export default function MainPageV2() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white flex flex-col safe-area-inset">
      {/* Header */}
      <header className="sticky top-0 z-20 bg-gray-800/80 backdrop-blur-md border-b border-gray-700/50 px-4 py-3 shadow-lg">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <SplitText
              text="COEX 이벤트 안내"
              className="text-lg lg:text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"
              delay={0.2}
              duration={1.2}
              stagger={0.1}
              animation="slideUp"
      ...
      {isSidebarOpen && (
        <>
          ...
          />
          <aside className="fixed top-0 right-0 h-full w-80 bg-gray-800 shadow-xl z-40 lg:hidden overflow-y-auto">
            <div className="p-4">
              ...
              <p className="text-sm text-gray-400 mb-4">AI의 행동을 정의하는 프롬프트를 설정하세요</p>
              <Textarea
      ...
      <div className="flex-1 flex flex-col lg:flex-row max-w-6xl mx-auto w-full min-h-0 gap-4 p-2 lg:p-4">
        ...
        <main className="flex-1 flex flex-col min-h-0">
          <Card className="flex-1 flex flex-col min-h-0">
              ...
              <div ref={chatRef} className="flex-1 overflow-y-auto p-2 lg:p-4 space-y-3 lg:space-y-4 overscroll-contain">
                {chatState.messages.length === 0 && (
                  <div className="flex flex-col items-center justify-center h-full text-center py-8 lg:py-12 px-4">
                    <div className="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center mb-4 animate-pulse">
                      <span className="text-xl lg:text-2xl">🤖</span>
                    </div>
                    <SplitText
                      text="COEX 이벤트 안내 AI"
                      className="text-lg lg:text-xl font-semibold text-gray-300 mb-2"
                      delay={0.5}
                      duration={1.0}
                      stagger={0.1}
                      animation="slideUp"
                    ...
                    <SplitWords
                      ...
                      className="text-gray-400 mb-6 max-w-md text-sm lg:text-base"
                      delay={1.2}
                      duration={0.8}
                      stagger={0.08}
                      animation="fadeIn"
            ...
            <CardFooter className="main-input-area border-t border-gray-700/50 bg-gray-800/50 p-2 lg:p-4 safe-bottom">
